...
from qubx.data.readers import STOCK_DAILY_SESSION, AsPandasFrame, CsvStorageDataReader, AsQuotes, AsOhlcvSeries, RestoreTicksFromOHLC
...
class TestDataReaders:
    ...
    def test_simulated_quotes_trades(self):
        ...
        d1 = r.read('SPY', transform=RestoreTicksFromOHLC(
